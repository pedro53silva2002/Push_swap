...
/*                                                                            */
/*                                                        :::      ::::::::   */
/*   push_swap_operations_rrr.c                         :+:      :+:    :+:   */
/*                                                    +:+ +:+         +:+     */
/*   By: peferrei <peferrei@student.42.fr>          +#+  +:+       +#+        */
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2024/07/03 14:39:50 by peferrei          #+#    #+#             */
/*   Updated: 2024/08/09 16:47:10 by peferrei         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void	ft_rra(t_list **stack_a)
{
	...
	return (free(tmp), free(tmp_last), ft_putstr_fd("rra\n", 1));
}
...
void	ft_rrb(t_list **stack_b)
{
	...
	return (free(tmp), free(tmp_last), ft_putstr_fd("rrb\n", 1));
}
